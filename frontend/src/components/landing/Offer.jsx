...
export const Offer = () => (
  <section id="membership" className="relative py-24 sm:py-32 scroll-mt-20">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-10">
      ...
      <div className="grid lg:grid-cols-5 gap-10 mt-16 items-start">
        <Reveal className="lg:col-span-3 relative" data-testid="offer-trainee-card">
          ...
          <div className="bg-[#0C0C1C] border-2 border-[#D395FF] rounded-3xl p-8 sm:p-10 hard-shadow-lav -rotate-1">
            <h3 className="font-display text-2xl sm:text-3xl display-skew">CHICADANCE Trainee Track</h3>
            <p className="mt-4">
              <span className="font-display text-5xl sm:text-6xl text-[#D395FF] display-skew">$20</span>
            ...
            <a
              ...
              className="btn-primary font-display text-base sm:text-lg w-full mt-8 px-8 py-4 rounded-full hard-shadow-electric inline-flex items-center justify-center gap-2"
            >
              Enter Trainee Mode
        ...
        <Reveal delay={0.15} className="lg:col-span-2 lg:mt-14" data-testid="offer-community-card">
          <div className="bg-[#0C0C1C] border-2 border-[#9CDAFF]/50 rounded-3xl p-8 rotate-1 hard-shadow-sky">
            <h3 className="font-display text-xl sm:text-2xl display-skew">CHICADANCE Community</h3>
            <p className="mt-4">
              <span className="font-display text-4xl sm:text-5xl text-[#9CDAFF] display-skew">$5</span>
              <span className="text-white/60 font-semibold">/month</span>
            </p>
            <p className="text-white/75 mt-4 text-sm md:text-base">
            ...
            <a
              ...
              className="btn-ghost font-bold w-full mt-8 px-8 py-4 rounded-full border-2 border-[#9CDAFF] text-[#9CDAFF] inline-flex items-center justify-center"
            >
              Join the Community
            </a>
          </div>
      ...
      <Reveal delay={0.2}>
        <p className="text-sm text-white/50 text-center mt-12" data-testid="offer-supporting-copy">
